<?php include_once('includes/header.php'); ?>
		...
		<?php session_start(); ?>
		<script type="text/javascript" src="assets/js/scripts/ver_prestamos.js"></script>
		<br>
		<br>
		<br>
		<div class="row">
			...
			<div class="col-md-12">
				<div class="contenido">
					...
					<?php include_once('modals/ver_prestamos.php'); ?>
